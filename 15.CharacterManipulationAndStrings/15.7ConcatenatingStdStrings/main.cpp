...
//A few ways around string literal concatenation
	...
	std::string str7{std::string{"Hello"} + " World"};//Turn one or both into a std::string object  and do the concatenation
...
/*1*/   std::string str12 = str10.append(str11);	//str10 changes as well as str12
...
/*2*/	std::string str15 {str14.append(5,'?')}; // Appends 5 '?' characters
	std::cout << "str15 : " << str15 << std::endl;
		
		
	std::string str16{"The world is our shared home."};
	std::string str17{"Hello "};
/*3*/	std::string str18{str17.append(str16,4,5)};// Append a sub-section of another string
