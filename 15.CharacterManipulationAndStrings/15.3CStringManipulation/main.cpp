...
//std::strlen : Find the length of a string
   ...
   //Array decays into pointer when we use const char*
    ...
    std::cout << "strlen(message1) : " << std::strlen(message1) << std::endl;	//5
	
	// Includes the null character
    std::cout << "sizeof(message1) : " << sizeof(message1) << std::endl<< std::size(message);//66
	
	//strlen still works with decayed arrays
	std::cout << "strlen(message2) : " << std::strlen(message2) << std::endl;//5//std::size gives ERROR
	
	//Prints size of pointer
    	std::cout << "sizeof(message2) : " << sizeof(message2) << std::endl;	//8 always
