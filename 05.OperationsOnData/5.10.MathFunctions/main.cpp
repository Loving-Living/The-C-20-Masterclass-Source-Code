...
int main(){
    ...
    //4. exp(x) : f(x) = e ^ x , where e = 2.71828 . Test the result here against a calculator
    ...
    //6.log(x) : reverse function of pow
	//if 2^3 = 8 , log 8 in base 2 = 3.  Log is like asking to which exponent should we elevate 2 to get eight ? 
	...
	//(i) log(x)
 	...
 	//(ii) log10(x)
		//10 ^ 4 = 10000  , to get 10k , you'd need to elevate 10 to the power of ? , this is log in base 10
    ...
    //8. round(x)
	//Halfway points are rounded away from 0. 2,5 is rounded to 5 for example
